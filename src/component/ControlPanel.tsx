...
function ControlPanel({
  ...
  return (
    ...
    >
      ...
      {/* 💡 Lights Brightness Control - UPDATED */}
        ...
        >
          <button
            ...
            style={{
              flex: 1,
              padding: "8px",
              background: lightsBrightness === 0 ? "#ff4444" : "#444",
              color: "#fff",
              border: "none",
              borderRadius: "6px",
              cursor: "pointer",
              ...
              fontSize: "12px",
              transition: "all 0.3s",
              opacity: lightsBrightness === 0 ? 1 : 0.8,
            }}
          >
            OFF
          </button>
          ...
          <button
            ...
            style={{
              flex: 1,
              padding: "8px",
              background: lightsBrightness > 0 ? "#00ff88" : "#444",
